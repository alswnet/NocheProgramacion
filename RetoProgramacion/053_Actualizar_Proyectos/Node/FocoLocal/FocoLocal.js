...
bot.on("message", msg => {
  ...
  } else if (BuscarPalabra(chatId, Mensaje, "encender", "1")) {} else if (BuscarPalabra(chatId, Mensaje, "apagar", "0")) {} else if (BuscarPalabra(chatId, Mensaje, "e", "1")) {} else if (BuscarPalabra(chatId, Mensaje, "a", "0")) {} else {
