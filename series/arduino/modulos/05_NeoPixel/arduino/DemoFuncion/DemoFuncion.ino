...
void loop() {
  colorBarrido(tira.Color(255, 0 , 0), 50);
  colorBarrido(tira.Color(0, 255 , 0), 50);
  colorBarrido(tira.Color(0, 0 , 255), 50);
  colorBarrido(tira.Color(200, 0, 200), 50);
  colorBarrido(tira.Color(200, 200, 0), 50);
  colorBarrido(tira.Color(0, 200, 200), 50);
}
